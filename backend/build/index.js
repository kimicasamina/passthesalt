...
var _user = _interopRequireDefault(require("./api/v1/routes/user"));
var _login = _interopRequireDefault(require("./api/v1/routes/login"));
var _note = _interopRequireDefault(require("./api/v1/routes/note"));
var _auth = _interopRequireDefault(require("./api/v1/routes/auth"));
